function templateMenuItem(item, category, index) {
    return `
        <div class="menu-item">
            ...
            <div class="menu-item-content">
                ...
                <div class="menu-item-price">
                    ...
                    <button class="add-to-cart" onclick="addToOrder('${category}', ${index})">add to cart</button>
                </div>
            </div>
        </div>
    `;
...
function templateWarningMessage() {
    return `
            <div style="text-align: center; padding: 30px 10px; color: var(--text); font-weight:bold">
